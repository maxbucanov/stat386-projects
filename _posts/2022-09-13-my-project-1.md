...
Although Data Science is an umbrella that includes data analytics, machine learning, data mining and several other related areas, I would like to focus particularly on Machine Learbning in this blog post.
