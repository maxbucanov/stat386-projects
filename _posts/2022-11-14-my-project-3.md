---
layout: post
title:  Picking Most Stable Dividend Stocks using Data Science. (Explaratory Data Analysis of The S&P 500 Index)
date:   2022-11-14
author: Max Bucanov
...
## Cleaning Dataset
Before starting my data analysis, I wrote down four questions that wanted to find the answers to. But before we get to them, I wanted to talk a little about data cleaning. As a Data Scientint, the first thing that I look at when working with dataframes is whether they need cleaning (dropping duplicates, replacing null values with numbers, converting string to numeric values, removing unwanted characters, etc.) I got lucky and my dataframe was already pretty clean, the only thing that I needed to do was removing a few characters from columns (such as **$** and **%**).
...
Also, as I was looking at the GICS sectors column in the dataframe, I noticed that **Information Technology** sector was listed twice. When data was entered, someone may have written "technology" with lower case. In order to fix that issue, I used the code below to rename the value.
 ...
 **_3. Three companies that meet all recomendations for investors?_**
...
In order to see if there are any stocks in the index that meet all of these requirements I ran the following python code:
...
Because I am not a Financial Advisor, I wanted to check if my findings were correct. I searched these four stocks online to see what analysts say about them. 3 out of 4 had a **buy** or a **moderate buy** rating. Only Masco Corp stock had a **Hold** rating. I checked what a negative PB value meant and it said that a negative PB value means that a company may have more total liabilities than assets. This doesn't automatically make a stock bad, but it was interesting to find that out.
...
Looking at the heatmap, we can see positive correlation between Price to Salse ratio and Price to Earnings Ratio. This makes sense, the more sales company makes, the bigger earnings it has.
But what we can also see on the heatmap is a negative correlation between Dividend Yield and P/E Ratio, and also P/S Ratio.
...
On this scatterplot we can see that that companies that pay larger dividends have a smaller P/E Ratio. Now, remember how I mentioned earlier that many tech companies do not pay dividends and have a higher P/E ratio? Now things start to make sense. Here is why:

Most stable companies pay didvidends because they no longer re-invest all profits into their growth, but pay dividends to their shareholders. These companies tend to have lower growth rate and lower P/E Ratio. Younger companies that focus on their growth, do not pay dividends because they re-invest the profits into their growth, which increases growth rate and PE/ Ratio.

### Conclusion
Now that we see statistical analysis of the stock market, we can figure out which companies are more stable and pay their shareholders dividends. The more profit company makes, it no longer re invests 100% of it into its growth, instead, it increases dividends.
We can also see why younger companies have a higher P/E ratio and how it affects company's ability to pay dividends.

**DISCLAMER**: This blog post is not a financial advice. I am just combing two topics that I am passionate about. Data Science and Stock Market. For  help with investing, please reach out to a professional.
