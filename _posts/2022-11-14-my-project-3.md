...
Also, as I was looking at the GICS sectors in the index, I noticed that **Information Technology** sector was listed twice in the dataframe only because when data was entered, someone made may have wrote technology with lower case. In order to fix that issue, I used the code below to rename the value.
...
**_As a result, here is a screenshot of my final cleaned dataframe:_**
